...
public class GamePanel implements ActionListener 
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if (e.getSource() == jb1) 
        {
            ...
            jb1.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb2) 
        {
            ...
            jb2.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb3) 
        {
            ...
            jb3.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb4) 
        {
            ...
            jb4.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb5) 
        {
            ...
            jb5.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb6) 
        {
            ...
            jb6.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb7) 
        {
            ...
            jb7.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb8) 
        {
            ...
            jb8.setFont(new Font("Areal", 1, 50));
        ...
        if (e.getSource() == jb9) 
        {
            ...
            jb9.setFont(new Font("Areal", 1, 50));
    ...
    void restartGame() 
    {
        ...
        else
        {
            ...
            {
                //JOptionPane.showMessageDialog(jf, "Series Drow");
                 new WhoWinSeries("Series Drow");
                 jf.setVisible(false);
            }
        }
    }
